...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_PitchEffect = 1f;            // The strength of effect for pitch input.  Вверх вниз
        [SerializeField] private float m_YawEffect = 0.2f;            // The strength of effect for yaw input. Сила воздействия на вход рыскания
        [SerializeField] private float m_BankedTurnEffect = 0.5f;     // The amount of turn from doing a banked turn. Количество оборотов от поворота в банке
        [SerializeField] private float m_AerodynamicEffect = 0.02f;   // How much aerodynamics affect the speed of the aeroplane. Сколько аэродинамики влияет на скорость полета самолета
        [SerializeField] private float m_AutoTurnPitch = 0.5f;        // How much the aeroplane automatically pitches when in a banked turn. Сколько самолёт автоматически ставится, когда в повороте
        [SerializeField] private float m_AutoRollLevel = 0.2f;        // How much the aeroplane tries to level when not rolling. How much the aeroplane tries to level when not rolling
        [SerializeField] private float m_AutoPitchLevel = 0.2f;       // How much the aeroplane tries to level when not pitching. Сколько самолет пытается выровнять, когда не качка
        [SerializeField] private float m_AirBrakesEffect = 3f;        // How much the air brakes effect the drag. Сколько воздушных тормозов влияет на сопротивление
        [SerializeField] private float m_ThrottleChangeSpeed = 0.3f;  // The speed with which the throttle changes. Скорость изменения дроссельной заслонки
        [SerializeField] private float m_DragIncreaseFactor = 0.001f; // how much drag should increase with speed. сколько сопротивления должно увеличиваться со скоростью
